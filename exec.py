    ...
    def buttonSend_clicked(self):
        if self.ui.editEmail.text() != '':
            sendMail([{
                ...
                'message': 'Если вы это читаете, то это означает, что все работает корректно!'
            }])
        else:
